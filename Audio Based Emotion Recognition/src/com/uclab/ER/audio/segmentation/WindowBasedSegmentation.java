package com.uclab.ER.audio.segmentation;
...
import com.uclab.ER.audio.interfaces.Segmentation;
...
public class WindowBasedSegmentation extends
	 ...
	 * @param samplerate
	 */
	public WindowBasedSegmentation(int sec, int samplerate, int channel) {
		this.threshold = sec * samplerate*channel;
	}
