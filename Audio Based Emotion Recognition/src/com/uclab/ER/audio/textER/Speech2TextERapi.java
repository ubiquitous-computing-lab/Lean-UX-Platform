package com.uclab.ER.audio.textER;
...
public class Speech2TextERapi {
   ...
   public static String STT(AudioInputStream fileContent) throws IOException {      
      ...
      try {
         url = new URL("https://kakaoi-newtone-openapi.kakao.com/v1/recognize"); // 호출할 url
      ...
      try {
         ...
         conn.getOutputStream().write(speeches); // POST 호출
      } catch (IOException e) {
         e.printStackTrace();
      }
      ...
      //Get data from Kakao API server
   ...
   public static double predict(String url_text, String text) {
      URL url = null;
      try {
