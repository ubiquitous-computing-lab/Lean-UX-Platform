...
class Log(models.Model):
    ...
    entry_screen = models.CharField(max_length=250, blank=True)
    exit_screen = models.CharField(max_length=250, blank=True)
    ...
    screen_resolution = models.CharField(max_length=250, blank=True)
    user_agent = models.CharField(max_length=250, blank=True)
    language = models.CharField(max_length=250, blank=True)
    country = models.CharField(max_length=250, blank=True)
    event_category = models.CharField(max_length=250, blank=True)
    event_name = models.CharField(max_length=250, blank=True)
    event_action = models.CharField(max_length=250, blank=True)
    event_value = models.CharField(max_length=250, blank=True)
